...
bot = telebot.TeleBot('6975859325:AAHVJ59iryGP6QOQE_eCYkTIhvUF10zocfM')
# обращаемся к классу Telebot, вставляем токен нашего бота
...
def callback(call):
    if call.data != 'else':
        ...
        bot.send_message(call.message.chat.id, 'Введите 2 валюты через слэш (/)')
